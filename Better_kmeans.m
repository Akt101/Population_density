function [label_im,vec_mean] = Better_kmeans(im,no_of_cluster,varargin)
[m,n,p] = size(im);
%% For Gray Images
if p<3
    gray = im;
    ...
    while(true)
        ...
        if (vec_mean==old_mean | itr>25)%change it accordingly
            break;
        end
    end
...
%         im = double(im);
        ...
        while(true)
            ...
            if ((meana1==olda & meanb1==oldb))%change it accordingly
                break;
            end
        end
